...
issue](https://github.com/cisagov/li-pca-app-docker/issues) in this
...
request](https://github.com/cisagov/li-pca-app-docker/pulls), you will
...
pyenv virtualenv <python_version_to_use> li-pca-app-docker
pyenv local li-pca-app-docker
